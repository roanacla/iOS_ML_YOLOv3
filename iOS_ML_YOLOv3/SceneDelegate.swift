...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
    ...
    guard let snapsTableViewController = navigationViewController.viewControllers[0] as? SnapsTableViewController else { return }
    snapsTableViewController.context = appDelegate.persistentContainer.viewContext
  }
